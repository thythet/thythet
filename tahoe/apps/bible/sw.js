const APP='tahoe-bible-app-v44',BIBLE='tahoe-shared-bible-v44',RUNTIME='tahoe-bible-runtime-v44';
const DATA=new URL('../../data/',self.location.href).href;
const ASSETS=new URL('../../assets/',self.location.href).href;
const SHELL=[
  './','index.html','app.js?v=44','manifest.webmanifest','search-worker.js',
