const APP='tahoe-powerslide-app-v45',BIBLE='tahoe-shared-bible-v45',RUNTIME='tahoe-powerslide-runtime-v45';
const DATA=new URL('../../data/',self.location.href).href;
const ASSETS=new URL('../../assets/',self.location.href).href;
const SHELL=[
  './','index.html','powerslide.js?v=45','powerslide.css?v=45','manifest.webmanifest',
