const APP='tahoe-bible-app-v60',BIBLE='tahoe-shared-bible-v60',RUNTIME='tahoe-bible-runtime-v60';
const DATA=new URL('../../data/',self.location.href).href;
const ASSETS=new URL('../../assets/',self.location.href).href;
const SHELL=[
  './','index.html','app.js?v=60','manifest.webmanifest','search-worker.js',
