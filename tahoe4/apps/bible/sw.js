const APP='tahoe-bible-app-v64',BIBLE='tahoe-shared-bible-v64',RUNTIME='tahoe-bible-runtime-v64';
const DATA=new URL('../../data/',self.location.href).href;
const ASSETS=new URL('../../assets/',self.location.href).href;
const SHELL=[
  './','index.html','app.js?v=62','manifest.webmanifest','search-worker.js',
